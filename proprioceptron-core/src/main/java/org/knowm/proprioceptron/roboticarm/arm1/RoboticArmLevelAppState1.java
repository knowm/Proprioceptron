 ...
 * @create Oct 31, 2012
 */
public class RoboticArmLevelAppState1 extends AbstractRoboticArmAppState {
   ...
   * @param pillSpeed
   */
  public RoboticArmLevelAppState1(SimpleApplication app, int levelId, int numJoints, float pillSpeed) {
